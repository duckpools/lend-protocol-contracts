```scala
{
	val collateralBoxScript  = fromBase58("3RpWJyaRe248dtPajAJg4qHFBMYLGQ3iMtg3GKwyzarf")
	val minTxFee      = 1000000L
	val minBoxValue   = 1000000L
	val poolNFT       = fromBase58("9wyjwbs7wTs6VxM77vieD4b68Jsc1ABVDtSnydYTRCt2")
 	val BorrowTokenId = fromBase58("DUGnHCbmwPoWETxspe5DzaQRbixHPnbDB3Fo6uA1JSc2")
	val PoolNativeCurrency = fromBase58("G5wxpJyY6acrYoSNETKEefio3NV5HjTmxq53iVgNSq4J")
	...
	val operation = if (OUTPUTS.size < 3) {
		...
		val validForcedLiquidation = collateralForcedLiquidation > HEIGHT + 150000
