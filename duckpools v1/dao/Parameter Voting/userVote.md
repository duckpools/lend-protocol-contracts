{
	// Constants
	val counterToken = fromBase58("AXPyTium5YtgZsqfXv5d5a73WAqpoTza5qPJpPTosmLx")
	val minimumCounterTokens = 10000 // In excess of 2 (to exclude proposal boxes)
	val cancellationCooldown = 20 // To Prevent spam on height validator
	val blocksInThreeMonths = 64800L
	...
	} || sigmaProp(PK("9iHt62h51xykRcbViDEcrRUsejeczdbXRUuyhYqocow4uhXApwQ") && HEIGHT > recordedSubmission + blocksInThreeMonths)
}